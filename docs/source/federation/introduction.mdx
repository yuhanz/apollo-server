...
Next, [keep reading](./architect-federated-graph) to learn more about how composition works and how to build a composed schema. You can also [clone a demo schema](https://github.com/apollographql/federation-demo) or [check out the CodeSandbox demo in your browser](https://codesandbox.io/s/v368r9ml47).
